                ...
                <div class="row">
                    ...
                    <div class="col-xl-6">
                        <div class="about-two__right">
                            ...
                            <p class="about-two__text-1">Lorem Ipsum is simply dummy text of the printing and typesetting industry. Has been the industry's standard dummy text ever since the 1500s, when an unknown printer took. It has survived not only five centuries, but also the leap into electronic typesetting, remaining essentially unchanged.</p>
                            <p class="about-two__text-2">Lorem Ipsum is simply dummy text of the printing and typesetting industry.</p>
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="video-one__inner">
                            ...
                            <h2 class="video-one__title">Lorem Ipsum sit Amet<br> Dolor Consecteur</h2>
                        </div>
                    </div>
                </div>
            </div>
                        ...
                        <div class="testimonial-one__single">
                            <div class="testimonial-one__client-info">
                                ...
                                <div class="testimonial-one__client-details">
                                    <h5 class="testimonial-one__client-name">Lorem Ipsum</h5>
        ...
        <section class="team-one about-page-team">
            <div class="container">
                <div class="section-title text-center">
                    <span class="section-title__tagline">Equipe Profissional</span>
                    <h2 class="section-title__title">Conheça nossa Liderança</h2>
                </div>
                <div class="row">
                <div class="col-xl-3 col-lg-6 col-md-6">
                        ...
                        <div class="team-one__single wow fadeInLeft" data-wow-delay="100ms" data-wow-duration="1000ms">
                            ...
                            <div class="team-one__content">
                                <h3 class="team-one__name">Lorem ipsum</h3>
                                <p class="team-one__title">dummy text of the printing</p>
                            </div>
                        </div>
                    </div>
                    <div class="col-xl-3 col-lg-6 col-md-6">
